...
public class Account {
    ...
    // TODO: Task3
    // replace the null with a lambda expression
    public static AddMaker maker = num -> {Consumer<Account> addMaker = e -> e.balance += num;
                                            return addMaker;};
    ...
    public static int getMaxAccountID(List<Account> accounts) {
        // TODO: Task4
        // replace the null with a lambda expression
        Account maxOne = accounts.stream().reduce(new Account(0, -100), (acct1, acct2) -> acct1.balance > acct2.balance?acct1:acct2);
